...
## D.1. Notre problème
_**Dans la partie C. du TP on a beaucoup amélioré l'organisation de notre code en le répartissant dans différents fichiers, mais on a quand même encore un problème.**_
